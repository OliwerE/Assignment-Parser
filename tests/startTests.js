...
const runTests = () => {
  ...
  console.log('tc7: Få end token typ QUESTION, Indata: "a. b! c?", Förväntat: "QUESTION": ' + handlePass(sentenceTests.tc7()))
  console.log('tc8: Få end token typ EXCLAMATION, Indata: "En mening!", Förväntat: "EXCLAMATION": ' + handlePass(sentenceTests.tc8()))
  console.log('tc9: Få end token typ EXCLAMATION, Indata: "a. b? c!", Förväntat: "EXCLAMATION": ' + handlePass(sentenceTests.tc9()))
  ...
  console.log('tc4: Returnera alla meningar med utropstecken, Indata: "a! b? c. d? e! f.", Förväntat: "Array som innehåller meningarna: a!, e!": ' + handlePass(documentTests.tc4()))
